        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              CustomTextField(label: "Email", controller: emailCtrl, keyboardType: TextInputType.emailAddress),
              CustomTextField(label: "Password", controller: passCtrl, isPassword: true),
              CustomTextField(label: "Confirm Password", controller: confirmCtrl, isPassword: true),
